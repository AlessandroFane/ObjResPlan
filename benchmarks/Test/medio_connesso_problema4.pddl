(define (problem Test/medio_connesso_problema4.pddl) (:domain navigation)
(:objects
    S0 - location
    S1 - location
    S2 - location
...
(:init
    ...
    (railway S0 S6 train2)
    (road S0 S7 bus1)
    (road S0 S8 bus1)
    (road S0 S9 bus3)
    (road S1 S2 bus2)
    (railway S1 S3 train2)
    (flight S1 S3 plane3)
    (road S1 S4 bus2)
    (railway S1 S4 train3)
    (road S1 S5 bus1)
