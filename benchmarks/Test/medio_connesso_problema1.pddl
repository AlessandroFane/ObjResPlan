(define (problem Test/medio_connesso_problema1.pddl) (:domain navigation)
(:objects
    S0 - location
    S1 - location
    S2 - location
...
(:init
    ...
    (flight S0 S7 plane1)
    (road S0 S8 bus1)
    (railway S0 S8 train1)
    (road S0 S9 bus1)
    (road S1 S2 bus2)
    (road S1 S3 bus2)
    (road S1 S5 bus1)
    (railway S1 S5 train1)
    (flight S1 S7 plane1)
    (road S1 S9 bus3)
    (road S2 S3 bus1)
    (road S2 S4 bus1)
    ...
    (road S2 S6 bus3)
    (railway S2 S6 train3)
    (road S2 S7 bus2)
    (railway S2 S7 train3)
    (road S2 S8 bus1)
    (railway S2 S9 train1)
    (road S3 S4 bus2)
    (railway S3 S5 train1)
    (flight S3 S5 plane1)
    (road S3 S6 bus2)
    (road S3 S7 bus3)
    (road S3 S8 bus2)
